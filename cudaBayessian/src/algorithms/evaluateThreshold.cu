...
void evaluateThresholdsGPU(
    ...
    // ============================================================
    float *d_log_diffs, *d_thresholds, *d_youden_scores;
    int *d_y_true;
    ...
    cudaMalloc(&d_youden_scores, n_thresholds * sizeof(float));
    ...
    evaluateThresholdsKernel<<<blocksPerGrid, threadsPerBlock>>>(
        d_log_diffs,
        d_y_true,
        d_thresholds,
        d_youden_scores,
    ...
    // ============================================================
    cudaMemcpy(h_youden_scores, d_youden_scores, n_thresholds * sizeof(float), 
